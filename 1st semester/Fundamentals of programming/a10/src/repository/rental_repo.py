...
class RentalRepo:
    ...
    def __init__(self):
        self._book = BookRepo()
        self._rentals = IterableStructure()
    ...
    def add_rental(self, rental):
        self.rentals._list.append(rental)
    ...
    def find_by_book_id(self, _book_id):
        ...
        """
        for i in range(len(self.rentals._list)):
