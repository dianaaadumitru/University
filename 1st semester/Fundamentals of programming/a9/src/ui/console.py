...
if __name__ == "__main__":
    ...
    if settings.get_repository_type() == "inmemory":
        ...
        # file_books_name = settings.get_book_file_name()
        # b = BookTextRepo(file_books_name)
        #
        # file_clients_name = settings.set_client_file_name()
        # c = ClientTextRepo(file_clients_name)
        #
        # file_rentals_name = settings.set_rental_file_name()
        # r = RentalTextRepo(file_rentals_name)
        ...
        # file_books_name = settings.get_book_file_name()
        # b = BookPickleRepo(file_books_name)
        #
        # file_clients_name = settings.set_client_file_name()
        # c = ClientPickleRepo(file_clients_name)
        #
        # file_rentals_name = settings.set_rental_file_name()
        # r = RentalPickleRepo(file_rentals_name)
