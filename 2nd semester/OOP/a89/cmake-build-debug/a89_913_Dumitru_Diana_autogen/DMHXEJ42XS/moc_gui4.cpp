...
struct qt_meta_stringdata_gui4_t {
    QByteArrayData data[1];
    char stringdata0[5];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_gui4_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_gui4_t qt_meta_stringdata_gui4 = {
    {
QT_MOC_LITERAL(0, 0, 4) // "gui4"
...
QT_INIT_METAOBJECT const QMetaObject gui4::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_gui4.data,
    qt_meta_data_gui4,
    qt_static_metacall,
    nullptr,
    nullptr
...
void *gui4::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_gui4.stringdata0))
