...
public:
    ...
    void retranslateUi(QWidget *guiClass)
    {
        ...
        descriptionInput->setPlaceholderText(QCoreApplication::translate("guiClass", "input description", nullptr));
        actInput->setPlaceholderText(QCoreApplication::translate("guiClass", "input act", nullptr));
        addButton->setText(QCoreApplication::translate("guiClass", "add", nullptr));
        acceptButton->setText(QCoreApplication::translate("guiClass", "accept", nullptr));
        savePlotButton->setText(QCoreApplication::translate("guiClass", "save plot", nullptr));
    } // retranslateUi
