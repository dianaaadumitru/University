...
public class PrgState {
    ...
    public PrgState(IStack<IStmt> stk, IDictionary<String, Value> symtbl, IList<Value> ot,
                    IDictionary<StringValue, BufferedReader> fT, IHeap<Value> givenHeap, ISemaphore<Pair<Integer, List<Integer>>> sTable, IStmt prg) {
        exeStack = stk;
        symTable = symtbl;
        out = ot;
        fileTable = fT;
    ...
    public String toString() {
        ...
        str.append("Semaphore Table: ").append(semaphoreTable).append("\n");
        str.append(" \n").append("\n").append("\n");
        return str.toString();
    }
