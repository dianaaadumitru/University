...
public class PrgState {
    ...
    public PrgState(IStack<IStmt> stk, IDictionary<String, Value> symtbl, IList<Value> ot,
                    IDictionary<StringValue, BufferedReader> fT, IHeap<Value> givenHeap, ISemaphore<Pair<Integer, List<Integer>>> givenSemaphore, IStmt prg) {
        exeStack = stk;
        symTable = symtbl;
        out = ot;
        fileTable = fT;
        heap = givenHeap;
        semaphoreTable = givenSemaphore;
