...
public class MainWindowController implements Initializable {
    ...
    private void populateBarrierTable(PrgState givenProgramState) {
        barrierTableView.setItems(FXCollections.observableList(new ArrayList<>(givenProgramState.getBarrierTable().getBarrier().entrySet())));
