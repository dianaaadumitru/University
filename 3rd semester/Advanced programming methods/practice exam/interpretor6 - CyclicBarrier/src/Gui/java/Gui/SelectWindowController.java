...
import Gui.model.*;
import Gui.model.statement.CyclicBarrier.AwaitStmt;
import Gui.model.statement.CyclicBarrier.NewBarrierStmt;
...
public class SelectWindowController implements Initializable {
    ...
    private List<IStmt> initExamples(){
        ...
        IStmt fork1 = new CompStmt(new AwaitStmt(new VarExp("cnt")),
        ...
        IStmt fork2 = new CompStmt(new AwaitStmt(new VarExp("cnt")),
                                        ...
                                        new CompStmt(new NewHeapStmt("v1",new ValueExp(new IntValue(2))),
                                                new CompStmt(new NewHeapStmt("v2",new ValueExp(new IntValue(3))),
                                                        new CompStmt(new NewHeapStmt("v3",new ValueExp(new IntValue(4))),
                                                                new CompStmt(new NewBarrierStmt(new VarExp("cnt"), new ReadHeapExp(new VarExp("v2"))),
