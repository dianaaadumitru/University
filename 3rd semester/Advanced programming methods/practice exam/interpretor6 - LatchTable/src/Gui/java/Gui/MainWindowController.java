...
public class MainWindowController implements Initializable {
    ...
    @FXML
    private TableColumn<Map.Entry<Integer, Integer>, String> latchTableLocation = new TableColumn<>();
    @FXML
    private TableColumn<Map.Entry<Integer, Integer>, String> latchTableValues = new TableColumn<>();
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        latchTableLocation.setCellValueFactory(p -> new SimpleStringProperty(p.getValue().getKey() + " "));
...
//        fileTableView.setItems(FXCollections.observableArrayList());
    ...
    private void populateLatchTableView(PrgState givenProgramState){
