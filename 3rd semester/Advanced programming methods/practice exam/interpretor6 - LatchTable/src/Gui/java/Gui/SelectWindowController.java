...
import Gui.model.*;
import Gui.model.statement.LatchTable.awaitStmt;
import Gui.model.statement.LatchTable.countDownStmt;
import Gui.model.statement.LatchTable.newLatchStmt;
...
public class SelectWindowController implements Initializable {
    ...
    private List<IStmt> initExamples(){
        ...
        IStmt fork3 = new CompStmt(new WriteHeapStmt("v3", new ArithExp(new ReadHeapExp(new VarExp("v3")), new ValueExp(new IntValue(10)), '*')),
                new CompStmt(new PrintStmt(new ReadHeapExp(new VarExp("v3"))),
                        new countDownStmt(new VarExp("cnt"))
                )
        );

        IStmt fork2 = new CompStmt(new WriteHeapStmt("v2", new ArithExp(new ReadHeapExp(new VarExp("v2")), new ValueExp(new IntValue(10)), '*')),
                new CompStmt(new PrintStmt(new ReadHeapExp(new VarExp("v2"))),
                        new CompStmt(new countDownStmt(new VarExp("cnt")),
                                new ForkStmt(fork3)
                        )
                )
        );

        IStmt fork1 = new CompStmt(new WriteHeapStmt("v1", new ArithExp(new ReadHeapExp(new VarExp("v1")), new ValueExp(new IntValue(10)), '*')),
                                   ...
                                   new CompStmt(new NewHeapStmt("v1",new ValueExp(new IntValue(2))),
                                           new CompStmt(new NewHeapStmt("v2",new ValueExp(new IntValue(3))),
                                                   new CompStmt(new NewHeapStmt("v3",new ValueExp(new IntValue(4))),
                                                           new CompStmt(new newLatchStmt(new VarExp("cnt"), new ReadHeapExp(new VarExp("v2"))),
                                                                   new CompStmt(new ForkStmt(fork1),
                                                                           new CompStmt(new awaitStmt(new VarExp("cnt")),
