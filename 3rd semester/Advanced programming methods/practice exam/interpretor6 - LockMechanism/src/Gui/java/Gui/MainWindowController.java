...
public class MainWindowController implements Initializable {
    ...
    @FXML
    private TableColumn<Map.Entry<Integer, Integer>, String> lockTableLocation = new TableColumn<>();
    @FXML
    private TableColumn<Map.Entry<Integer, Integer>, String> lockTableValues = new TableColumn<>();
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        lockTableLocation.setCellValueFactory(p -> new SimpleStringProperty(p.getValue().getKey() + " "));
        lockTableValues.setCellValueFactory(p-> new SimpleStringProperty(p.getValue().getValue() + " "));
...
//        fileTableView.setItems(FXCollections.observableArrayList());
    ...
    private void populateLock(PrgState givenProgramState) {
        lockTableView.setItems(FXCollections.observableList(new ArrayList<>(givenProgramState.getLockTable().getLock().entrySet())));
