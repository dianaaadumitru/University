...
import Gui.model.*;
import Gui.model.statement.LockMechanism.LockStmt;
import Gui.model.statement.LockMechanism.UnlockStmt;
import Gui.model.statement.LockMechanism.newLockStmt;
...
public class SelectWindowController implements Initializable {
    ...
    private List<IStmt> initExamples(){
        ...
        IStmt example_10 = new CompStmt(new VarDeclStmt("v1", new RefType(new IntType())),
                        ...
                        new CompStmt(new VarDeclStmt("v2", new RefType(new IntType())),
                                new CompStmt(new NewHeapStmt("v2", new ValueExp(new IntValue(30))),
                                        new CompStmt(new VarDeclStmt("x", new IntType()),
                                                new CompStmt(new newLockStmt(new VarExp("x")), new CompStmt(
                                                        new ForkStmt( new CompStmt(new ForkStmt(new CompStmt(new LockStmt(new VarExp("x")),
                                                                new CompStmt(new WriteHeapStmt("v1", new ArithExp(new ReadHeapExp(new VarExp("v1")), new ValueExp(new IntValue(1)), '-')),
                                                                        new UnlockStmt(new VarExp("x"))))),
                                                                new CompStmt(new LockStmt(new VarExp("x")),
                                                                        new CompStmt(new WriteHeapStmt("v1", new ArithExp(new ReadHeapExp(new VarExp("v1")), new ValueExp(new IntValue(1)),'+')),
                                                                                new UnlockStmt(new VarExp("x")))))),
                                                        new CompStmt(new VarDeclStmt("q", new IntType()),
                                                                new CompStmt(new newLockStmt(new VarExp("q")),
                                                                        new CompStmt(new VarDeclStmt("m", new IntType()),
                                                                                new CompStmt(new VarDeclStmt("z", new IntType()),
                                                                                        new CompStmt(new ForkStmt(
                                                                                                new CompStmt(new ForkStmt(new CompStmt(new LockStmt(new VarExp("q")),
                                                                                                        new CompStmt(new WriteHeapStmt("v2", new ArithExp(new ReadHeapExp(new VarExp("v2")), new ValueExp(new IntValue(5)), '+')), new UnlockStmt(new VarExp("q"))))),
                                                                                                        new CompStmt(new AssignStmt("m", new ValueExp(new IntValue(100))),
                                                                                                                new CompStmt(new LockStmt(new VarExp("q")),new CompStmt(new WriteHeapStmt("v2", new ArithExp(new ReadHeapExp(new VarExp("v2")), new ValueExp(new IntValue(1)), '+')),new UnlockStmt(new VarExp("q"))))))),
                                                                                                new CompStmt(new AssignStmt("z", new ValueExp(new IntValue(200))),
                                                                                                        new CompStmt(new AssignStmt("z", new ValueExp(new IntValue(300))),
                                                                                                                new CompStmt(new AssignStmt("z", new ValueExp(new IntValue(400))),
                                                                                                                        //new CompoundStatement(new LockStmt("x"),
                                                                                                                        new CompStmt(new PrintStmt(new ReadHeapExp(new VarExp("v1"))),
                                                                                                                                new CompStmt(new UnlockStmt(new VarExp("x")),
                                                                                                                                        new CompStmt(new LockStmt(new VarExp("q")),
                                                                                                                                                new CompStmt(new PrintStmt(new ReadHeapExp(new VarExp("v2"))),
                                                                                                                                                        new UnlockStmt(new VarExp("q")))))))))))))))))))));



        IStmt fork2 = new CompStmt(new LockStmt(new VarExp("x")),
                new CompStmt(new WriteHeapStmt("v1", new ArithExp(new ReadHeapExp(new VarExp("v1")), new ValueExp(new IntValue(1)), '-')),
                        new UnlockStmt(new VarExp("x"))
                )
        );

        IStmt fork1 = new CompStmt(new ForkStmt(fork2),
                new CompStmt(new LockStmt(new VarExp("x")),
                ...
                new CompStmt(new VarDeclStmt("v2", new RefType(new IntType())),
                        new CompStmt(new VarDeclStmt("x", new IntType()),
                                new CompStmt(new VarDeclStmt("q", new IntType()),
                                        new CompStmt(new NewHeapStmt("v1", new ValueExp(new IntValue(20))),
                                                new CompStmt(new NewHeapStmt("v2", new ValueExp(new IntValue(30))),
                                                        new CompStmt(new newLockStmt(new VarExp("x")),
