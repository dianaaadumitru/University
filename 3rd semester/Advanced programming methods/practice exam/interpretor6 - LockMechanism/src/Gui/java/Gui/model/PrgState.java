...
public class PrgState {
    ...
    public void setLockTable(ILock lockTable) {
        this.lockTable = lockTable;
    }

    public PrgState(IStack<IStmt> stk, IDictionary<String, Value> symtbl, IList<Value> ot, IDictionary<StringValue, BufferedReader> fT, IHeap<Value> givenHeap, ILock givenLock, IStmt prg) {
        exeStack = stk;
        symTable = symtbl;
        out = ot;
        fileTable = fT;
