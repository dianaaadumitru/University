...
public class MainWindowController implements Initializable {
    ...
    @FXML
    private TableView<Map.Entry<Integer, Pair<Integer, Pair<Integer, List<Integer>>>>> semaphoreTableView;
    @FXML
    private TableColumn<Map.Entry<Integer, Pair<Integer, Pair<Integer, List<Integer>>>>,String> indexColumn;
    @FXML
    private TableColumn<Map.Entry<Integer, Pair<Integer, Pair<Integer, List<Integer>>>>,String> valueColumn;
    @FXML
    private TableColumn<Map.Entry<Integer, Pair<Integer, Pair<Integer, List<Integer>>>>,String> listColumn;
    ...
    private void populateSemaphore(PrgState givenProgramState){
        semaphoreTableView.setItems(FXCollections.observableList(new ArrayList<>(givenProgramState.getSemaphoreTable().getSemaphore().entrySet())));
