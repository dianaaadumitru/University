...
import Gui.model.*;
import Gui.model.statement.ToySemaphore.AcquireStmt;
import Gui.model.statement.ToySemaphore.NewSemaphore;
import Gui.model.statement.ToySemaphore.ReleaseStmt;
    ...
    private List<IStmt> initExamples(){
        ...
        IStmt forked1 = new CompStmt(new AcquireStmt(new VarExp("cnt")),
                new CompStmt(new WriteHeapStmt("v1",new ArithExp(new ReadHeapExp(new VarExp("v1")),new ValueExp(new IntValue(10)), '*')),
                        new CompStmt(new PrintStmt(new ReadHeapExp(new VarExp("v1"))), new ReleaseStmt(new VarExp("cnt")))));
        ...
        IStmt example_10 = new CompStmt(new VarDeclStmt("v1",new RefType(new IntType())),
                new CompStmt(new VarDeclStmt("cnt", new IntType()),
                        new CompStmt(new NewHeapStmt("v1",new ValueExp(new IntValue(2))),
                                new CompStmt(new NewSemaphore(new VarExp("cnt"), new ReadHeapExp(new VarExp("v1")), new ValueExp(new IntValue(10))),
