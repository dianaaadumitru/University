...
public class PrgState {
    ...
    private ISemaphore<Pair<Integer, Pair<Integer, List<Integer>>>> semaphoreTable;
    private int stateID;
    private static int freeID = 1;
    private IStmt originalProgram; //optional field, but good to have

    public ISemaphore<Pair<Integer, Pair<Integer, List<Integer>>>> getSemaphoreTable() {
        return semaphoreTable;
    }

    public void setSemaphoreTable(ISemaphore<Pair<Integer, Pair<Integer, List<Integer>>>> semaphoreTable) {
        this.semaphoreTable = semaphoreTable;
    }

    public PrgState(IStack<IStmt> stk, IDictionary<String, Value> symtbl, IList<Value> ot,
                    IDictionary<StringValue, BufferedReader> fT, IHeap<Value> givenHeap, ISemaphore<Pair<Integer, Pair<Integer, List<Integer>>>> sTable, IStmt prg) {
        exeStack = stk;
        symTable = symtbl;
        out = ot;
        fileTable = fT;
        heap = givenHeap;
        semaphoreTable = sTable;
