...
public class SwitchStmt implements IStmt{
    ...
    public PrgState execute(PrgState state) throws StmtException, ExprException, ADTException {
        IStmt st = new IfStmt(new RelationalExp(exp, exp1, "=="), statement1,
                new IfStmt(new RelationalExp(exp, exp2, "=="), statement2, statement3));
    ...
    public IStmt deepCopy() {
        return new SwitchStmt(exp.deepCopy(), exp1.deepCopy(), exp2.deepCopy(), statement1.deepCopy(), statement2.deepCopy(), statement3.deepCopy());
    }
    ...
    public IDictionary<String, Type> typecheck(IDictionary<String, Type> typeEnv) throws MyException {
        ...
        if (type.equals(type1) && type.equals(type2))
            return statement1.typecheck(statement2.typecheck(statement3.typecheck(newEnv)));
        else
    ...
    public String toString(){
        return "switch(" + exp +") (case (" + exp1 + "): " + statement1 + ") (case (" + exp2 + "): " + statement2 +
                ") (default: " + statement3;
    }
}
