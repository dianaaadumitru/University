...
public class Main {
    ...
    private static void WriteInFile() {
        int i = 0;
        try {
            BufferedWriter writer = new BufferedWriter(new FileWriter("C:\\Users\\diana\\Desktop\\uni work\\5th sem\\pdp\\lab1\\src\\data\\products.txt"));
            while ( i < 1000 ) {
                Random r = new Random();
    ...
    private static void ReadFromFile() {
        File file = new File("C:\\Users\\diana\\Desktop\\uni work\\5th sem\\pdp\\lab1\\src\\data\\products.txt");
        try {
